...
namespace margelo::nitro::haptics {
  ...
  public:
    // Get the Swift part
    inline NitroHaptics::HybridHapticsSpec_cxx getSwiftPart() noexcept { return _swiftPart; }
  ...
  public:
    // Methods
    inline void notification(NotificationFeedbackType style) override {
      auto __result = _swiftPart.notification(static_cast<int>(style));
